import sys
import json
from PyQt6.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QSizePolicy, QScrollArea, QFrame, QLabel, QPushButton, QMainWindow, QToolBar, QComboBox, QFileDialog, QSpacerItem
from PyQt6.QtCore import Qt, pyqtSignal
from PyQt6.QtGui import QIcon, QAction, QFont
from vueProduit import VueProduit, ProduitWidget
...
##########################################################
        ...
        # Choix des magasins avec un bouton
        ...
        self.showMaximized()  # Permet de mettre en écran total
...
##########################################################
    ...
    def ajouter_produit_liste(self, nom_produit):
        ...
        if self.liste_layout.count() > 1:  # Si il s'agit du premier produit dans la liste, on n'ajoute pas de ligne séparatrice
            ligne_separation = QFrame()
            ligne_separation.setFrameShape(QFrame.Shape.HLine)
            ligne_separation.setFrameShadow(QFrame.Shadow.Sunken)
    ...
    def ouvrir_fichier(self):
        fileName, _ = QFileDialog.getOpenFileName(self, "Ouvrir le fichier", "", "JSON Files (*.json);;All Files (*)")
        if fileName:
